...
public class ClassPathContractMapperScanner extends ClassPathBeanDefinitionScanner {

    public ClassPathContractMapperScanner(BeanDefinitionRegistry registry) {
        super(registry);
    }
    ...
    private void processBeanDefinisions(Set<BeanDefinitionHolder> definitions) {
        ...
        for (BeanDefinitionHolder holder : definitions) {
            ...
            definition.setBeanClass(ContractMapperFactoryBean.class);
